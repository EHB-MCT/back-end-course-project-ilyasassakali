        ...
        <div class="px-6 py-4 w-1/2">
            ...
            <form action="" method="POST"  id="edit-form">
                ...
                <div class="flex mb-4">
                    ...
                    <div class="flex ">
                        <div id="semester_div" class=" ml-4">
                            <label class="block font-medium text-sm text-gray-700" for="semester">Semester</label>
                            <input type="number" id="edit-semester" name="semester" style="width: 120px" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" readonly>
                        </div>

                        <div id="duur_div" class="  ml-4">
                            <label class="block font-medium text-sm text-gray-700" for="duur">Duur</label>
                            <input type="time" id="edit-duur" name="duur" style="width: 120px" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" readonly>
                        </div>

                        <div id="sessies_div" class="  ml-4">
                            <label class="block font-medium text-sm text-gray-700" for="sessies">Sessies</label>
                            <input type="text" id="edit-sessies" name="sessies" style="width: 120px" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" readonly>
                        </div>
                    </div>
                </div>
