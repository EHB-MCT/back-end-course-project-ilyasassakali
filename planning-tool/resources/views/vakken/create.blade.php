                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ url('vak') }}" method="post" class="max-w-md mx-auto mt-4 ">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="naam" id="naam" class="w-3/4 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm ">
                        </div>
                        <div class="mb-4">
                            <label for="opleiding" class="block font-medium text-sm text-gray-700">Opleiding</label>
                            <input type="text" name="opleiding" id="opleiding" class="w-3/4 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        </div>
                        <div class="mb-4">
                            <label for="semester" class="block font-medium text-sm text-gray-700">Semester</label>
                            <input type="text" name="semester" id="semester" class="w-3/4 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        </div>
