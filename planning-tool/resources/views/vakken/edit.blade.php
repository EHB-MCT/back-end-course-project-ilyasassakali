                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('vak.update', $vakken->id) }}" method="post" class="max-w-md mx-auto mt-4 ">
                        ...
                        <div class="mb-4">
                            ...
                            <input value="{{$vakken->semester}}" type="number" name="semester" id="semester" class="w-3/4 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        </div>
                        <div class="mb-4">
                            <label for="duur" class="block font-medium text-sm text-gray-700">Duur</label>
                            <input min="00:00" max="10:00" value="{{$vakken->duur}}" type="time" name="duur" id="duur" class="w-3/4 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        </div>
                        <div class="mb-4">
                            <label for="sessies" class="block font-medium text-sm text-gray-700">Sessies</label>
                            <input value="{{$vakken->sessies}}" type="number" name="sessies" id="sessies" class="w-3/4 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        </div>
